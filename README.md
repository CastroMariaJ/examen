...
<!-- ============================================================================
     NUEVO: Sección completa de Gestion de Estudiantes
     Antes no existía este módulo - los estudiantes se registraban libremente
     ============================================================================ -->
### 4. Gestion De Estudiantes

Modulo privado para administrar los estudiantes autorizados para presentar examenes.
...
Permite crear, editar, eliminar y listar estudiantes. La identificacion y el email no se pueden repetir.
...
<!-- ============================================================================
     MODIFICADO: Numeración cambiada de 4 a 5 por la nueva sección de estudiantes
     ============================================================================ -->
### 5. Resolucion Publica De Examenes
...
<!-- ============================================================================
     MODIFICADO: Paso 3 y 4 cambiados
     ANTES: El estudiante ingresaba identificacion y nombre completo manualmente
     AHORA: Solo ingresa identificacion y el sistema verifica si existe
     ============================================================================ -->
3. Ingresa su numero de identificacion.
4. El sistema comprueba que exista en el registro de estudiantes. Si no existe, bloquea el acceso y muestra un mensaje.
5. Presenta el examen.
6. El sistema muestra un temporizador en tiempo real.
7. El estudiante selecciona una respuesta por pregunta.
8. El estudiante termina el examen o el sistema lo finaliza cuando el tiempo llega a cero.
9. El sistema calcula el porcentaje obtenido.
10. El sistema muestra si aprobo o no aprobo.
11. El resultado se guarda en localStorage.
...
<!-- ============================================================================
     NUEVO: Archivo agregado para el modulo de estudiantes
     ============================================================================ -->
├── estudiantes.html    # Gestion de estudiantes
...
<!-- ============================================================================
     NUEVO: Estructura de datos del estudiante
     Antes no existía - ahora es necesaria para el flujo de verificación
     ============================================================================ -->
### Estructura De Estudiante

Los estudiantes se guardan en `acme_students`:
...
<!-- ============================================================================
     MODIFICADO: Validación actualizada - solo pide identificación
     ANTES: El estudiante ingresaba identificación y nombre completo
     AHORA: Solo ingresa identificación y el sistema verifica su existencia
     ============================================================================ -->
- El estudiante debe ingresar unicamente su identificacion.
- La identificacion debe existir en `acme_students`; de lo contrario no puede iniciar.
...
Para probar el flujo publico puede usarse el estudiante inicial:
